...
if ! [[ -f 'Server-0.12.9.zip' ]]; then
	...
	curl -Lo 'Server-0.12.9.zip' 'https://github.com/ThePansmith/Monifactory/releases/download/0.12.9/Monifactory-Release.0.12.9-server.zip' 
	ln -s /data /data/overrides
	unzip -u -o 'Server-0.12.9.zip' -d /data
	rm /data/overrides
