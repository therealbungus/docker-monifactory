...
if ! [[ -f 'Server-0.12.4.zip' ]]; then
	...
	curl -Lo 'Server-0.12.4.zip' 'https://github.com/ThePansmith/Monifactory/releases/download/0.12.4/Monifactory-Beta.0.12.4-server.zip' 
	ln -s /data /data/overrides
	unzip -u -o 'Server-0.12.4.zip' -d /data
	rm /data/overrides
