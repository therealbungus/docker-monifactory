...
if ! [[ -f 'Server-0.12.0.zip' ]]; then
	...
	curl -Lo 'Server-0.12.0.zip' 'https://github.com/ThePansmith/Monifactory/releases/download/0.12.0/Monifactory-Beta.0.12.0-server.zip' 
	ln -s /data /data/overrides
	unzip -u -o 'Server-0.12.0.zip' -d /data
	rm /data/overrides
